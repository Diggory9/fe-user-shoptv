    ...
    const handleFinish = async (values: any) => {
        ...
        apiContactUs
            ...
            .then((res) => {
                if (res?.ok) {
                    toast.success(
                        "Hệ thống đã tiếp nhận câu hỏi của bạn. Nhân viên hỗ trợ sẽ sớm liên hệ lại với bạn."
                    );
                    form.setFieldsValue({
                        fullName: "",
                        email: "",
            ...
            .catch((error) => {
                toast.success(
                    "Hệ thống đang gặp sự cố. Xin vui lòng thử lại sau ít phút"
                );
            });
    };
    return (
                ...
                >
                                    ...
                                    rules={[
                                        {
                                            required: true,
                                            message:
                                                "Vui lòng nhập thông tin cần hỏi",
                                        },
                                    ]}
                                >
                                    <Input.TextArea
                    ...
                    <div className="w-full flex justify-end px-10">
                        <button
                            ...
                            type="submit"
                            className=" text-white text-xl font-semibold px-3 py-2 rounded-lg"
                        >
                            Gửi yêu cầu
                        </button>
                    </div>
