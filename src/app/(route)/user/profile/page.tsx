            ...
            <div className="flex items-center space-x-4">
                <div className="w-full">
                    <div className="flex justify-between w-full">
                        <h2 className="text-xl font-semibold text-gray-800 w-1/2">
                            {" "}
                            Họ và tên:{" "}
                        </h2>
                        <h2 className="text-xl font-semibold text-gray-800 w-1/2">
                            {info?.fullName || "Chưa có thông tin"}
                        </h2>
                    </div>
                    <div className="flex justify-between w-full">
                        <h2 className="text-xl font-semibold text-gray-800  w-1/2">
                        ...
                        <p className="text-xl font-semibold text-gray-800 w-1/2">
                            {info?.displayName || "Chưa có thông tin"}
                        </p>
                    </div>
                    <div className="flex justify-between w-full">
                        <h2 className="text-xl font-semibold text-gray-800  w-1/2">
                    ...
                    <div className="flex justify-between w-full">
                        ...
                        <p className="text-gray-600 w-1/2">
                            {info?.phone || "Chưa thiết lập số điện thoại"}
                        </p>
                    </div>
                    <div className="flex justify-between w-full">
