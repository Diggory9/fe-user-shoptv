...
export default function CheckoutReturn() {
    ...
    const [statusOrder, setStatusOrder] = useState<'success' | 'error' | 'warning'>('success')
    useEffect(() => {
        ...
        const savePaymentData = async () => {
            ...
            ApiCheckout.createOrderVnpay(txnRef || '').then((data) => {
                setOrder(data.data);
                ...
                setStatusMessage("Có lỗi xãy ra trong quá trình tạo đơn hàng")
            ...
            }
            {
                statusOrder === 'warning' && (
                    <Result
                        ...
                        subTitle={(
                            <div>
                                <p>Đơn hàng đang xãy ra lỗi xin vui lòng liên hệ đến để giải đáp thắc mắc</p>
                                <p>Nếu có thắc mắc vui lòng liên hệ đến 034421414 để giải đáp</p>
                            </div>
                        )}
                    />
